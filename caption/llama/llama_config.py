...
def getCaption(image_url, metadata, language_code):
    print(f"Language Code: {language_code}")
    if language_code == 'id':
        instructions = "Anda adalah bot penulisan caption gambar yang dirancang untuk menghasilkan caption deskriptif berdasarkan gambar yang diberikan. Ikuti instruksi ini dengan cermat:"
        instructions_metadata = "Masukkan metadata berikut ke dalam caption untuk membentuk caption yang lengkap dan koheren:"
        ...
        instructions_metadata = "Incorporate the following metadata into the caption to form a complete and coherent sentence:"
